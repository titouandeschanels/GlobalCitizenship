    ...
    const ringsData: { title: string, text: React.ReactNode }[] = [
        {
            ...
            text: (
                <div>
                    <br /><TextBold>Demos-playground & Participatory Democracy</TextBold><br />
        ...
        },
        {
            ...
            text: (
                <div>
                    <br /><TextBold>Me & my Circles 2.0 (society, the world)</TextBold><br />
        ...
        },
        {
            ...
            text: (
                <div>
                    <br /><TextBold>Me & others (my circles 1.0)</TextBold><br />
        ...
        },
        {
            ...
            text: (
                <div>
                    <br /><TextBold>“Me as a Global Citizen”</TextBold><br />
